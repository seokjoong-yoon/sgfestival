...
urlpatterns = [
    ...
    path('review_korean/<int:index>', views.foodtruck_review_korean, name='foodtruck_review_korean'),
    path('review_western/<int:index>', views.foodtruck_review_western, name='foodtruck_review_western'),
    path('review_dessert/<int:index>', views.foodtruck_review_dessert, name='foodtruck_review_dessert'),
    path('review_etc/<int:index>', views.foodtruck_review_etc, name='foodtruck_review_etc'),
]
